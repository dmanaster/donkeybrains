class CertificatesController < ApplicationController
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.pdf do
        ...
        send_data pdf.render, filename: "certificate_#{@certificate.id}.pdf",
  ...
  def create
    ...
    respond_to do |format|
      if @certificate.save
        format.html { redirect_to certificate_path(@certificate, :format => 'pdf'), notice: 'Certificate was successfully created.' }
  ...
  private
    ...
    def certificate_params
      params.require(:certificate).permit(:name, :institution, :state, :president, :psychiatrist)
    end
end
