...
class CertificatesControllerTest < ActionController::TestCase
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post :create, certificate: { institution: @certificate.institution, name: @certificate.name, reason: @certificate.reason }
    end
  ...
  test "should update certificate" do
    patch :update, id: @certificate, certificate: { institution: @certificate.institution, name: @certificate.name, reason: @certificate.reason }
    assert_redirected_to certificate_path(assigns(:certificate))
  end
